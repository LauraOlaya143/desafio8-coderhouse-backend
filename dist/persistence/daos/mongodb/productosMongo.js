...
exports["default"] = exports.MongoProductosController = void 0;
var _productos = require("./schemas/productos.js");
...
var ClientMongo = /*#__PURE__*/function () {
  ...
  _createClass(ClientMongo, [{
    ...
    key: "getProductById",
    value: function () {
      var _getProductById = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(id) {
        var product;
    ...
    key: "createProduct",
    value: function () {
      var _createProduct = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(object) {
        var title, price, thumbnail, timestamp, descripcion, codigo, stock, newProduct;
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                title = object.title, price = object.price, thumbnail = object.thumbnail, timestamp = object.timestamp, descripcion = object.descripcion, codigo = object.codigo, stock = object.stock;
                _context3.next = 3;
                return _productos.ProductsModel.create({
                  title: title,
                  price: price,
                  thumbnail: thumbnail,
                  timestamp: timestamp,
    ...
    key: "updateProduct",
    value: function () {
      var _updateProduct = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(id, array) {
        var title, price, thumbnail, timestamp, descripcion, codigo, stock, product, productUpdated;
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                title = array.title, price = array.price, thumbnail = array.thumbnail, timestamp = array.timestamp, descripcion = array.descripcion, codigo = array.codigo, stock = array.stock;
                _context4.next = 3;
                return _productos.ProductsModel.findById(id);
              case 3:
              ...
              case 8:
                ...
                return _context4.abrupt("return", productUpdated);
              case 10:
              case "end":
